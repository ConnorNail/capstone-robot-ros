...
echo_and_run cd "/home/robot/ws_moveit/src/moveit/moveit_commander"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/robot/ws_moveit/src/moveit/moveit_commander/setup.py" \
     \
    build --build-base "/home/robot/ws_moveit/build/moveit/moveit_commander" \
    install \
    --root="${DESTDIR-/}" \
