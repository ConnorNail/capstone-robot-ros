...
echo_and_run cd "/home/robot/ws_moveit/src/moveit/moveit_ros/visualization"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/robot/ws_moveit/src/moveit/moveit_ros/visualization/setup.py" \
     \
    build --build-base "/home/robot/ws_moveit/build/moveit/moveit_ros/visualization" \
    install \
    --root="${DESTDIR-/}" \
