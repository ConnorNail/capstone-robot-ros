...
echo_and_run cd "/home/robot/ws_moveit/src/universal_robot/ur_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/robot/ws_moveit/src/universal_robot/ur_kinematics/setup.py" \
     \
    build --build-base "/home/robot/ws_moveit/build/universal_robot/ur_kinematics" \
    install \
    --root="${DESTDIR-/}" \
